package pack.databaseConnection;
...
public class DatabaseConnection {
    ...
    private final String url = "jdbc:mysql://127.0.0.1:3306/pao_db?createDatabaseIfNotExist=true";
    ...
    private static void createTables(Connection connection) {
        String delimiter = ";";
        try (Scanner scanner = new Scanner(new File("src/pack/databaseConnection/tables.sql"))) {
